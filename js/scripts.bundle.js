    ...
    const t = "active",
        ...
        a = () => {
            ...
            $(".sidebar-toggler").on("click", function () {
                (a = !a), $(this).toggleClass(t), e.attr("data-sidebar-toggle", a ? "true" : null);
            });
        },
        i = () => {
        ...
        l = () => {
            $(".swiper").each(function () {
                const t = parseInt(this.getAttribute("data-swiper-slides"), 10),
                    ...
                    o = this.getAttribute("data-swiper-pagination") ? this.getAttribute("data-swiper-pagination") : "bullets",
                ...
                let u = t,
                    g = 1,
                    m = 2;
                1 === t ? (g = m = 1) : t > 1 && t < 5 ? ((g = 2), (m = 1)) : t >= 5 && ((g = 3), (m = 2));
                const h = { speed: 500, slidesPerView: m, slidesPerGroup: 1, spaceBetween: 16, a11y: !0, rtl: Utils.isRTL(), breakpoints: { 576: { slidesPerView: g }, 1200: { slidesPerView: u, spaceBetween: 24 } } };
                a && (h.loop = a),
                    i && (h.autoplay = { delay: 5e3, disableOnInteraction: !1, pauseOnMouseEnter: !0 }),
                    s && (h.breakpoints[1200].grid = { rows: p, fill: "row" }),
                    l && n && (h.navigation = { nextEl: l, prevEl: n }),
                    r && (h.pagination = { el: r, type: o, clickable: !0, dynamicBullets: !0 }),
        ...
        r = () => {
            $(document).on("click", 'a:not([href^="#"])a:not([href^="mail"])a:not([href^="tel"]):not([href^="javascript"]):not(.external):not([target])', function (t) {
                t.preventDefault(), t.stopPropagation();
                const e = $(this).closest("#sidebar"),
                    a = "undefined" !== $(this).attr("href") ? $(this).attr("href") : null;
                if (a) {
            ...
            s.show().animate({ width: 20 + 80 * Math.random() + "%" }, 200),
                $.ajax({ url: a, type: "GET", dataType: "html" })
                    .done(function (t, e, a) {
                        "success" === e &&
                            200 == a.status &&
                            ((t = $("<div>" + t + "</div>")), $("head title").html(t.find("title").html()), $("#wrapper").html(t.find("#wrapper").html()), $("html, body").animate({ scrollTop: 0 }, 100), u(), d(), p(), Dashboard.init());
                    })
                    .fail(function () {
                        window.location.href = "404.html";
                    })
                    .always(function () {
                        i && i.length && $(window).width() < 992 && ($(".sidebar-toggler").toggleClass(t), e.removeAttr("data-sidebar-toggle")),
        ...
        d = () => {
            ...
            t && e && a && (e.setAttribute("data-header", t.header), a.setAttribute("data-sidebar", t.sidebar));
        },
        c = (t, e, a) => {
            t.each(function () {
                const t = $(this)
                    ...
                    .split(" ")
                    .map(function (t) {
                        return t.startsWith(e) || t.endsWith("start") || t.endsWith("end") ? t.replace(e, a) : t;
                    });
        ...
        p = () => {
            if (Utils.isRTL()) {
                ...
                let e = t.map((t) => {
                    return (e = t), $(`[class^="${e}"], [class*=" ${e}"], [class$="${e}"],[class*="${e} "]`);
                    var e;
                });
                (e = e.map((t) =>
                    t.filter((t, e) => {
                    ...
                    e.forEach((e, a) => {
                        const i = t[a],
                            s = i.endsWith("start") || i.endsWith("end") ? ((n = i).endsWith("start") ? n.replace("start", "end") : n.replace("end", "start")) : (l = i).endsWith("e") ? l.replace("e", "s") : l.replace("s", "e");
                        var l, n;
                        c(e, i, s);
                    });
            }
        ...
        u = () => {
            if ((s(), l(), document.querySelector(".dropzone") && ((Dropzone.autoDiscover = !1), new Dropzone(".dropzone", { url: "/file/post" })), n(), a(), i(), $(".amplitude-play-pause").hasClass("amplitude-playing"))) {
                const e = Amplitude.getActiveSongMetadata();
                $("[data-play-id]").removeClass(t), $("[data-play-id=" + e.id + "]").addClass(t);
            }
        };
    return {
        init() {
                ...
                if ((t && t.destroy(), e)) {
                    const a = {
                        ...
                        options: {
                            ...
                            scales: { x: { position: Utils.isRTL() ? "right" : "left", display: !1 }, y: { position: Utils.isRTL() ? "right" : "left", display: !1, min: 0, max: 85 } },
                    ...
                    if ((i && i.destroy(), t)) {
                        const e = {
                            ...
                            options: {
                                ...
                                elements: { borderJoinStyle: "bevel", borderCapStyle: "round", line: { tension: 0.4 } },
                                scales: {
                                    y: { position: Utils.isRTL() ? "right" : "left", min: 0, max: 80, grid: { borderColor: Utils.isDarkMode() ? "#34343e" : "#EFF2F5" } },
                                    x: { position: Utils.isRTL() ? "right" : "left", grid: { borderColor: Utils.isDarkMode() ? "#34343e" : "#EFF2F5" } },
                                },
                                layout: { margin: 0, padding: 0 },
                                plugins: { legend: { display: !1 } },
                            },
...
var Player = (function () {
    var t = "active",
                ...
                Amplitude.init({
                    ...
                    callbacks: {
                        song_change: function () {
                            n(() => {
                                v(), "playing" === Amplitude.getPlayerState() ? g() : $("[data-play-id]").removeClass(t), d(s);
                            });
                        },
                    },
                });
        ...
        o = function (t) {
            ...
            return { id: parseInt(e.data("song-id")), name: e.data("song-name"), artist: e.data("song-artist"), album: e.data("song-album"), url: e.data("song-url"), cover_art_url: e.data("song-cover") };
        },
        d = function (t) {
            var e = $("#player_options");
            e.find("[data-favorite-id]").attr("data-favorite-id", t.id), e.find("[data-playlist-id]").attr("data-playlist-id", t.id), e.find("[download]").attr("href", t.url);
        },
        c = function (t = !0) {
            $(".amplitude-repeat, .amplitude-prev, .amplitude-next, .amplitude-shuffle").prop("disabled", t);
        },
        p = function (t) {
            var e = Amplitude.getActiveSongMetadata();
            return `<div class="list__item"\n        data-song-id="${t.id}"\n        data-song-name="${t.name}"\n        data-song-artist="${t.artist}"\n        data-song-album="${t.album}"\n        data-song-url="${
                t.url
            }"\n        data-song-cover="${t.cover_art_url}">\n            <div class="list__cover">\n                <img src="${t.cover_art_url}" alt="${
                t.name
            }">\n                <a href="javascript:void(0);" class="btn btn-play btn-sm btn-default btn-icon rounded-pill ${"playing" === Amplitude.getPlayerState() && t.id === e.id ? "active" : ""}" data-play-id="${
                t.id
            }">\n                    <i class="ri-play-fill icon-play"></i>\n                    <i class="ri-pause-fill icon-pause"></i>\n                </a>\n            </div>\n            <div class="list__content">\n                <a href="song-details.html" class="list__title text-truncate">${
                t.name
            }</a>\n                <p class="list__subtitle text-truncate">\n                    <a href="artist-details.html">${
                t.artist
            }</a>\n                </p>\n            </div>\n            <ul class="list__option">\n                <li class="list__icon-hover">\n                    <a role="button" class="d-inline-flex" data-remove-song-id="${
                t.id
            }">\n                        <i class="ri-close-line fs-6"></i>\n                    </a>\n                </li>\n                <li>\n                    <a role="button" class="d-inline-flex" data-favorite-id="${
                t.id
        ...
        h = function () {
            $(".amplitude-play-pause").removeClass("amplitude-playing").addClass("amplitude-paused"), $("[data-play-id]").removeClass(t);
        },
        v = function () {
            ...
            if ("mediaSession" in navigator) {
                ...
                (a.metadata = new MediaMetadata({
                    ...
                    i.length >= 1 && !l.playPause && ((l.playPause = !0), a.setActionHandler("play", () => (Amplitude.play(), m(), void g())), a.setActionHandler("pause", () => (Amplitude.pause(), void h()))),
                    i.length >= 2 && !l.nextPrev && ((l.nextPrev = !0), a.setActionHandler("previoustrack", () => Amplitude.prev(e)), a.setActionHandler("nexttrack", () => Amplitude.next(e)));
            }
        };
    return {
        volumeBackground: function () {
            var t = $('.player-volume input[type="range"]'),
                ...
                i = "linear-gradient(to right, rgb(" + a + ") 0%, rgb(" + a + ") " + e + "%, rgba(" + a + ", 0) " + e + "%, rgba(" + a + ", 0) 100%)";
            t.css("background", i);
        },
        init: function () {
            var l;
            !(function () {
                if (Utils.getLocalItem("songs") && Utils.getLocalItem("songs").length && ((i = Utils.getLocalItem("songs")), r(!1), h(), i.length > 1))
                ...
                e.on("click", "[data-play-id]", function () {
                    ...
                    $(this).hasClass(t) ? (Amplitude.pause(), h()) : -1 === s ? (i.push(e), 1 === i.length ? r() : (a.append(p(e)), Amplitude.playSongAtIndex(i.length - 1))) : Amplitude.playSongAtIndex(s), Utils.setLocalItem("songs", i);
                }),
                e.on("click", "[data-queue-id]", function () {
                    var t = o(this);
                    -1 === i.findIndex((e) => e.id === t.id) ? (i.push(t), 1 === i.length ? r() : a.append(p(t))) : Utils.showMessage("Song already in Queue"), Utils.setLocalItem("songs", i);
                }),
                e.on("click", "[data-next-id]", function () {
                    var t = o(this),
                        e = Amplitude.getActiveIndex(),
                        s = i.findIndex((e) => e.id === t.id);
                    i && !i.length ? (i.push(t), r()) : -1 === s ? (i.splice(e + 1, 0, t), a.find(".list__item").eq(e).after(p(t))) : Utils.showMessage("Song already in Queue"), Utils.setLocalItem("songs", i);
                }),
                ...
                e.on("click", "[data-remove-song-id]", function (t) {
                    ...
                    s > -1 && (a.remove(), Amplitude.removeSong(s), 0 === i.length && u()), Utils.setLocalItem("songs", i);
                }),
                $("#clear_playlist").on("click", function () {
                    if (i.length >= 1) {
                        for (var t = 0; t < i.length; t++) a.find(".list__item").eq(t).remove();
                ...
                (l = $(".player-volume")).find('input[type="range"]').on("input", function () {
                    ...
                    Player.volumeBackground(),
                        0 === s
                            ...
                            : s > 70 && (t.addClass(r), e.addClass(r), a.removeClass(r).addClass(n));
                }),
                $(".amplitude-play-pause").on("click", function () {
                    v(),
                        n(() => {
                            "playing" === Amplitude.getPlayerState() ? g() : $("[data-play-id]").removeClass(t);
                        });
                }),
        ...
        t.fn.extend({
            ...
            (t.settings = function (i, d) {
                var c,
                    ...
                    m = "setting",
                    h = "Theme Settings",
                    v = ["red", "green", "blue", "orange", "yellow", "purple", "indigo", "pink", "violet", "magenta"],
                    y = (t = !1) => {
                        var e = a.getElementById("header"),
                            i = a.getElementById("sidebar"),
                            c = a.getElementById("player"),
                            p = { dark: d.dark, system: d.system, rtl: d.rtl, header: d.header, sidebar: d.sidebar, player: d.player };
                        t || p.dark || p.system || !s.hasAttribute(l) || (p.dark = !0),
                            "rtl" == a.dir && (p.rtl = !0),
                            Utils.setLocalItem(g, p),
                            p.dark ? s.setAttribute(l, "dark") : s.removeAttribute(l),
                            p.rtl ? a.documentElement.setAttribute("dir", "rtl") : a.documentElement.removeAttribute("dir"),
                            ...
                            r.on("click", function () {
                                ...
                                s
                                    ? (t("[data-theme-option]").removeClass(c),
                                      "system" === s ? ((d.system = !0), (d.dark = !1), e.matchMedia && e.matchMedia("(prefers-color-scheme: dark)").matches && (d.dark = !0)) : ((d.system = !1), (d.dark = "dark" === s)),
                                      Utils.changeSkin())
                                    : o
                                    ? (e.location.reload(), i.is(":checked") ? a.documentElement.setAttribute("dir", "rtl") : a.documentElement.removeAttribute("dir"), (d.rtl = i.is(":checked")))
                                    : l
                                    ? (t("[data-header-option]").removeClass(c), (d.header = l))
                                    : n
                                    ? (t("[data-sidebar-option]").removeClass(c), (d.sidebar = n))
                                    : r && (t("[data-player-option]").removeClass(c), (d.player = r)),
                                    i.addClass(c),
                                    y(!0);
                            });
                    };
                (u = Utils.getLocalItem(g)) && (d = t.extend({}, d, u)),
                    ...
                    s.appendChild(c),
                    b(),
                    d.system ? t('[data-theme-option="system"]').addClass("active") : d.dark ? t('[data-theme-option="dark"]').addClass("active") : t('[data-theme-option="light"]').addClass("active"),
            ...
            (t.settings.defaults = { dark: !1, system: !1, rtl: !1, header: null, sidebar: null, player: null });
    })(jQuery, window, document);
const Utils = {
    getCSSVarValue(t) {
        var e = getComputedStyle(document.documentElement).getPropertyValue("--bs-" + t);
    ...
    showMessage(t) {
        Snackbar.show({ pos: this.isRTL() ? "bottom-left" : "bottom-right", text: t, showAction: !1 });
    },
    changeSkin() {
        setTimeout(() => {
    ...
    isDarkMode: () => "dark" === document.querySelector("body").getAttribute("data-theme"),
